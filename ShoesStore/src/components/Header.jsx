...
const Header = (props) => {
  ...
  return (
    <header>
      <div className="px-4 py-2.5 bg-blue-300">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          <div className="text-slate-900 text-[13px] flex flex-wrap items-center gap-x-4 gap-y-1">
            <span>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                className="size-4 fill-slate-900 hover:fill-blue-700 transition"
                aria-hidden="true"

...
export default function Header() {
  ...
  const handleLogout = () => {
    ...
    // Navigate là conponent của react-router-dom 
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 ">
      <nav
        className="flex py-2 px-4 md:px-8 bg-black border-b border-slate-300 dark:border-neutral-700 dark:bg-neutral-900 min-h-[68px] relative z-20 "
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 w-full">
          ...
          >
            ...
            <ul className="flex flex-col gap-8 font-semibold text-sm text-stone-100 dark:text-slate-50 lg:flex-row max-lg:p-6">
              <li>
                <NavLink
                  to="/"
              ...
              <li>
                {/* thay thế thẻ a thành => Navlink hoặc link của react-router-dom */}
                <NavLink
                  to="/about"
          ...
          <div className="flex items-center gap-4">
            {/* Nếu có user info => hiện tên user và nút logout */}
            {userInfo ? (
              <div className="flex items-center gap-4">

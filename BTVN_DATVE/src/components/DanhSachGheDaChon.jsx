          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b border-yellow-900/50">
                <td className="text-orange-400 py-2 px-3 font-bold">A1</td>
                <td className="text-orange-400 py-2 px-3">150.000</td>
                <td className="py-2 px-3 text-center">
                  <span className="text-red-500 font-bold text-base leading-none cursor-pointer">
                    ✕
                  </span>
                </td>
              </tr>
              {/* Ghế A2 */}
              <tr className="border-b border-yellow-900/50">
                <td className="text-orange-400 py-2 px-3 font-bold">A2</td>
                <td className="text-orange-400 py-2 px-3">150.000</td>
                <td className="py-2 px-3 text-center">
                  <span className="text-red-500 font-bold text-base leading-none cursor-pointer">
                    ✕
              ...
              {/* Ghế A3 */}
              <tr className="border-b border-yellow-900/50">
                <td className="text-orange-400 py-2 px-3 font-bold">A3</td>
                <td className="text-orange-400 py-2 px-3">150.000</td>
                <td className="py-2 px-3 text-center">
                  <span className="text-red-500 font-bold text-base leading-none cursor-pointer">
                    ✕
